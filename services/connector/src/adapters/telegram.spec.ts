...
const getMe = vi.fn(async () => ({ id: 1, is_bot: true, first_name: 'OpenAlpha', username: 'openalice_bot' }))
...
describe('Telegram polling readiness', () => {
  beforeEach(() => {
    ...
    stopMock.mockReset()
    getMe.mockReset()
    getMe.mockResolvedValue({ id: 1, is_bot: true, first_name: 'OpenAlpha', username: 'openalice_bot' })
